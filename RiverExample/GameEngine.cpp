...
Engine::Engine() {
    ...
    m_AppName = L"River Example - Stochastic Grammar";
...
void Engine::DrawLine(const Vector2D& start, const Vector2D& end, float width) {

    HPEN blackPen = CreatePen(PS_SOLID, int(width), RGB(0, 128, 255)); // create Pen 
...
void Engine::ClearBackground() {
    HBRUSH hOldBrush, hNewBrush = CreateSolidBrush(RGB(50,100,50));
